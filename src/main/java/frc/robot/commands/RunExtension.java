...
public class RunExtension extends CommandBase {
    DigitalInput endSwitch = new DigitalInput(1);
    DigitalInput startSwitch = new DigitalInput(0);
    ...
    public void execute() {
        ...
        SmartDashboard.putBoolean("end switch", endSwitch.get());
        SmartDashboard.putBoolean("start switch", startSwitch.get());
    }
