...
// The robot's subsystems
    ...
    public final ExtendPn m_extendPn = new ExtendPn();
...
private final XboxController driverController = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("RunPnueArm", new RunPnueArm( m_extendPn ));
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
    SmartDashboard.putData("LevelSelf", new LevelSelf( m_driveTrain ));
    ...
    SmartDashboard.putData("Score Low", new ScoreLow( m_driveTrain ));
    SmartDashboard.putData("DoNothing", new DoNothing());
    SmartDashboard.putData("AutoLowerWrist", new AutoLowerWrist( m_clawWrist ));
    SmartDashboard.putData("runLights", new runLights( m_lights ));
    ...
    m_extendPn.setDefaultCommand(new RunPnueArm( m_extendPn ));
    ...
    m_chooser.addOption("DriveXFeet: Six", new DriveXFeet(-6, m_driveTrain));
    m_chooser.addOption("Score Low", new ScoreLow(m_driveTrain));
    ...
    m_chooser.addOption("Score Low", new ScoreLow(m_driveTrain));
    m_chooser.addOption("DoNothing", new DoNothing());
    m_chooser.addOption("pull up and level", new PullUpAndLevel(m_driveTrain));
    m_chooser.addOption("Correct Drive", new DriveXFeetold(-6, m_driveTrain));
...
// Create some buttons
final JoystickButton toggleArm = new JoystickButton(auxController, XboxController.Button.kA.value);        
toggleArm.toggleOnTrue(new RunPnueArm( m_extendPn ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("ToggleArm",new RunPnueArm( m_extendPn ));
