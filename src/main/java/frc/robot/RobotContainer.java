...
private final XboxController driverController = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    m_navX.setDefaultCommand(new DisplayInRange( m_limelight ));
...
// Create some buttons
final JoystickButton buttonFlipWrist = new JoystickButton(auxController, XboxController.Button.kLeftStick.value);        
buttonFlipWrist.toggleOnTrue(new FlipWrist(false, m_clawWrist).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton buttonCloseClaw = new JoystickButton(auxController, XboxController.Button.kA.value);        
buttonCloseClaw.onTrue(new RunClaw(true, m_pnuematicClaw).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("ButtonCloseClaw",new RunClaw(true, m_pnuematicClaw));
                        
final JoystickButton buttonOpenClaw = new JoystickButton(auxController, XboxController.Button.kB.value);        
buttonOpenClaw.onTrue(new RunClaw(false, m_pnuematicClaw).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
